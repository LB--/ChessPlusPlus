#ifndef chesspp_server_board_Board_HeaderPlusPlus
#define chesspp_server_board_Board_HeaderPlusPlus
        ...
        * \brief
        ...
        public:
            ...
            class Movements
            {
                ...
                friend class ::chesspp::server::board::Board;
        ...
        public:
            ...
            using MovementsRange = common::util::Range<Movements_t::const_iterator>;
