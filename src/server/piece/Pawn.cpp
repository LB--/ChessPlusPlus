...
namespace chesspp { namespace server
{
    namespace piece
    {
        ...
        (
            ...
            {
                auto d = common::util::Direction::None;
        ...
        Pawn::Pawn(board::Board &b, Position_t const &pos_, Suit_t const &s_, Class_t const &pc, common::util::Direction const &face)
        : Piece{b, pos_, s_, pc}
        , facing{face}
        {
        }
        ...
        {
            using namespace common::util_ops;
            if(moves == 1 && m != pos)
