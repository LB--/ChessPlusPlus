#ifndef chesspp_server_config_BoardConfig_HeaderPlusPlus
#define chesspp_server_config_BoardConfig_HeaderPlusPlus
...
namespace chesspp { namespace server
{
    namespace config
    {
        ...
        public:
            ...
            using Position_t = common::util::Position<BoardSize_t>; //Position type is based on Board Size type
        ...
        public:
            ...
            common::util::JsonReader::NestedValue metadata(Args const &... path) const
            {
