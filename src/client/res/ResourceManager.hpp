#ifndef chesspp_client_res_ResourcesManager_HeaderPlusPlus
#define chesspp_client_res_ResourcesManager_HeaderPlusPlus
...
namespace chesspp { namespace client
{
    namespace res
    {
        ...
        {
            common::config::Configuration &conf;
        ...
        public:
             ...
             */
            ResourceManager(common::config::Configuration &conf_) noexcept
